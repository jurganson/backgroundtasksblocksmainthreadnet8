...
namespace BackgroundTasksBlocksMainThreadNET8;
...
public partial class MainPage : ContentPage
{
	...
	{
#if DEBUG
		InfoLabel.Text = "NET8 - Debug " + DeviceInfo.Current.Platform;
#else
		InfoLabel.Text = "NET8 - Release " + DeviceInfo.Current.Platform;
#endif
	}
